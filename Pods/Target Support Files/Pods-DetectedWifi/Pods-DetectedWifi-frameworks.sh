...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "Pods-DetectedWifi/Alamofire.framework"
  install_framework "Pods-DetectedWifi/FontAwesomeKit.framework"
  install_framework "Pods-DetectedWifi/ReactiveCocoa.framework"
  install_framework "Pods-DetectedWifi/Result.framework"
